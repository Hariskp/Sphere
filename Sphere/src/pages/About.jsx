    ...
    <>
      ...
      <div className="Hero-banner-about">
        <div className="box-sphere-about">
          ...
          <div className="font-information-about">
            <p>
              Climate and environment are all important things in our lives in
              today's world, whether we are doing various activities or tasks,
              but it cannot be denied that these things have a great impact on
              the process life because the weather and environment change every
              day, making daily life sometimes difficult. You may be concerned
              about participating in various activities because the weather may
              be unfavorable at times. You must forego activities and miss out
              on opportunities. We will also have to deal with natural disasters
              on occasion. Unexpected environmental conditions cause significant
              harm to people, homes, and property. However, if the weather can
              be predicted, including the ability to warn of disasters ahead of
              time, this will have a positive impact on Live life to the
              fullest.
            </p>
          </div>
        </div>
        <div className="sphere-developer-about">
          <div className="developer-box-about">
            ...
            <div className="box-about">
              ...
              <div className="quote-f">
                <h4>
                  " The body needs a bed, and the space beside it needs you "
                </h4>
              </div>
            </div>
          </div>
